          ...
          fieldChecks: [
            {
              ...
              matched: raw?.name_match_result ? String(raw?.name_match_result).toUpperCase() == 'DIRECT_MATCH' : None,
            ...
            },
            {
              ...
              score: 100 if toNullableString(raw?.ifsc_details?.ifsc ?? ifsc) == toNullableString(ifsc) else 0,
              reason: 'BANK_IFSC_MATCH' if toNullableString(raw?.ifsc_details?.ifsc ?? ifsc) == toNullableString(ifsc) else 'BANK_IFSC_MISMATCH',
            },
          ],
          confidence: averageScore([nameMatchScore, 100 if toNullableString(raw?.ifsc_details?.ifsc ?? ifsc) == toNullableString(ifsc) else 0]),
