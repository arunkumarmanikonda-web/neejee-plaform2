      ...
      <div className="grid lg:grid-cols-3 gap-6 mt-8">
        ...
        <div className="space-y-4">
          <section className="bg-beige p-5">
            ...
            <p className="text-sm text-kohl">{seller.contactName || String.fromCharCode(0x2014)}</p>
            <p className="text-xs text-mitti mt-1">{seller.email || String.fromCharCode(0x2014)}</p>
            <p className="text-xs text-mitti">{seller.phone || String.fromCharCode(0x2014)}</p>
            {seller.user ? (
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-ivory border border-mitti/15 p-4">
                    ...
                    <div className="space-y-1 text-xs">
                      ...
                      <p className="text-mitti">{agreement.company?.address || String.fromCharCode(0x2014)}</p>
                      <p className="text-mitti">GSTIN: {agreement.company?.gstin || String.fromCharCode(0x2014)}</p>
                      <p className="text-mitti">PAN: {agreement.company?.pan || String.fromCharCode(0x2014)}</p>
                      <p className="text-mitti">Authorised signatory: {agreement.company?.authorisedSignatory || String.fromCharCode(0x2014)}</p>
                      <p className="text-mitti">Title: {agreement.company?.signatoryTitle || String.fromCharCode(0x2014)}</p>
                    </div>
                  ...
                  <div className="bg-ivory border border-mitti/15 p-4">
                    ...
                    <div className="space-y-1 text-xs">
                      <p className="text-kohl">{agreement.seller?.businessName || String.fromCharCode(0x2014)}</p>
                      <p className="text-mitti">Contact: {agreement.seller?.contactName || String.fromCharCode(0x2014)}</p>
                      <p className="text-mitti">Email: {agreement.seller?.email || String.fromCharCode(0x2014)}</p>
                      <p className="text-mitti">Phone: {agreement.seller?.phone || String.fromCharCode(0x2014)}</p>
                      ...
                      <p className="text-mitti">Payout cycle: {agreement.commercialTerms?.payoutCycle || String.fromCharCode(0x2014)}</p>
                      ...
                      <p className="text-mitti">Cluster: {agreement.commercialTerms?.cluster || String.fromCharCode(0x2014)}</p>
                    </div>
                  </div>
                </div>
